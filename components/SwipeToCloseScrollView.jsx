 ...
 */
const SwipeToCloseScrollView = forwardRef(
  ({threshold = 0, onScrollEndDrag, onClose, children, ...props}, ref) => {
    ...
    return (
      <ScrollView ref={ref} {...props} onScrollEndDrag={handleScrollEndDrag}>
        {children}
      </ScrollView>
    );
  },
