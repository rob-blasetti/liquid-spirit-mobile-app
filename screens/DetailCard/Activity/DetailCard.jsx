...
const ActivityCardBody = ({
  ...
  const mapDisplayAddress = coalesceString(mapAddress, getStreetAndSuburb(nextSession?.address), getStreetAndSuburb(address));
    ...
    >
      ...
      <View style={styles.overlayCard} key="card-body">
        ...
        <OverviewSection
          ...
          handleFacilitatorRequest={() => onRequestFacilitator?.(userId)}
          handleParticipantRequest={() => onRequestParticipant?.(userId)}
